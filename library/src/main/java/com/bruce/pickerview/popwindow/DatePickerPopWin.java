...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initView() {
        ...
        contentView = LayoutInflater.from(mContext).inflate(showDayMonthYear ? R.layout.layout_date_picker : R.layout.layout_date_picker_inverted, null);
...
//                initDayPickerView();
    ...
    private void initPickerViews() {
        ...
        for (int j = 0; j < 12; j++) {
            // For months in words
//            String smonth = new DateFormatSymbols().getMonths()[j];
